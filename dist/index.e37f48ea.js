...
new (0, _sortablejsDefault.default)(hand, {
    group: "shared",
    animation: 260,
    chosenclass: "boxShadow",
    dragClass: "drag"
});
new (0, _sortablejsDefault.default)(gameArea, {
    group: "shared",
    animation: 260,
    chosenclass: "boxShadow",
    dragClass: "drag"
...
function drawfromDeck(number) {
    ...
    hand.insertAdjacentHTML("afterbegin", ` <div class="cards" draggable="true"><img src="${(0, _modelJs.state).activeDeck[random].url}" alt="" /></div>`);
...
function generateRandomNumbers(number) {
    ...
    while(randomArray.length < randomNumber){
        const randomNumber = Math.floor(Math.random() * `${(0, _modelJs.state).activeDeck.length}`);
...
function populateCollection(i) {
    ...
    let colCard = `<img class="card cards-collection" draggable="true" data-set="${i}" src="${(0, _cardsJs.creatures)[i].url}" alt=""/>`;
    // card.innerHTML = colCard;
    modal_content.insertAdjacentHTML("afterbegin", colCard);
}
(0, _cardsJs.creatures).forEach((creature, i)=>populateCollection(i));
// populateCollection();
...
let builderCollectionCards = document.querySelectorAll(".builder-collection-cards");
...
allCollectionCards.forEach((card)=>{
    card.addEventListener("click", ()=>{
        ...
        (0, _modelJs.state).activeDeck.push((0, _cardsJs.creatures)[card.dataset.set]);
        let tempCard = card.cloneNode();
        // console.log(tempCard);
        let count = checkCardCopies((0, _cardsJs.creatures)[card.dataset.set]);
        if (count > 3) return;
...
const checkCardCopies = function(cardtomove) {
    builderCollectionCards = document.querySelectorAll(".builder-collection-cards");
    console.log(cardtomove.name);
    console.log(builderCollectionCards);
    let count = 1;
    // if (count === 3) return;
    builderCollectionCards.forEach((card)=>{
        console.log((0, _cardsJs.creatures)[card.dataset.set].name);
        if ((0, _cardsJs.creatures)[card.dataset.set].name === cardtomove.name) count++;
    });
    return count;
};

},{"./cards.js":"8nBRx","sortablejs":"4mik1","./model.js":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8nBRx":[function(require,module,exports) {
// import foop from '../../staic/*.jpg';
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "creatures", ()=>creatures);
var _jpg = require("../../src/img/cards/*.jpg");
const creatures = [
    {
        name: "furok",
        url: _jpg.furok,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../src/img/cards/*.jpg":"f2Q2K"}],"gkKU3":[function(require,module,exports) {
...
},{}],"f2Q2K":[function(require,module,exports) {
const _temp0 = require("654148e87ebd0597");
const _temp1 = require("7c0510ca77b1eda8");
const _temp2 = require("36470d7b750ef362");
const _temp3 = require("cfa5d257730a18de");
const _temp4 = require("744086c4738301d7");
const _temp5 = require("ae21309bde31680f");
const _temp6 = require("5bf50b5dcc85f77e");
const _temp7 = require("3b3f20f9fc9187ed");
const _temp8 = require("f4f831e498771b21");
const _temp9 = require("34d241e2e862302c");
const _temp10 = require("7e36f9310e81adc8");
const _temp11 = require("2d744d12da54ff38");
const _temp12 = require("c68b17ff57c7d948");
const _temp13 = require("9c68bfef203183ca");
const _temp14 = require("ffe01d8a1b93cf04");
const _temp15 = require("514add3af79f4c48");
const _temp16 = require("5dad9ebc1598a71a");
module.exports = {
    "baloo_root": _temp0,
    "crag_quor": _temp1,
    "fire_chogo": _temp2,
...
},{"654148e87ebd0597":"dGxaA","7c0510ca77b1eda8":"bwKcz","36470d7b750ef362":"ijDgM","cfa5d257730a18de":"lnlDq","744086c4738301d7":"gfB5f","ae21309bde31680f":"jVv9L","5bf50b5dcc85f77e":"eIptc","3b3f20f9fc9187ed":"aRgeV","f4f831e498771b21":"bYaMo","34d241e2e862302c":"gxtEa","7e36f9310e81adc8":"kOY6C","2d744d12da54ff38":"9To9y","c68b17ff57c7d948":"ezoMt","9c68bfef203183ca":"cXf1U","ffe01d8a1b93cf04":"jF8u0","514add3af79f4c48":"dzo96","5dad9ebc1598a71a":"9c7ER"}],"dGxaA":[function(require,module,exports) {
module.exports = require("2934345971926088").getBundleURL("hWUTQ") + "baloo_root.12b37b79.jpg" + "?" + Date.now();

},{"2934345971926088":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"bwKcz":[function(require,module,exports) {
module.exports = require("d0a1452ad6470b29").getBundleURL("hWUTQ") + "crag_quor.84669b92.jpg" + "?" + Date.now();

},{"d0a1452ad6470b29":"lgJ39"}],"ijDgM":[function(require,module,exports) {
module.exports = require("4311d9998c538a91").getBundleURL("hWUTQ") + "fire_chogo.101583d0.jpg" + "?" + Date.now();

},{"4311d9998c538a91":"lgJ39"}],"lnlDq":[function(require,module,exports) {
module.exports = require("bbeeb006df4ce902").getBundleURL("hWUTQ") + "furok.fd0e7be8.jpg" + "?" + Date.now();

},{"bbeeb006df4ce902":"lgJ39"}],"gfB5f":[function(require,module,exports) {
module.exports = require("7e588bd6446e8b56").getBundleURL("hWUTQ") + "gloom.b2e7b195.jpg" + "?" + Date.now();

},{"7e588bd6446e8b56":"lgJ39"}],"jVv9L":[function(require,module,exports) {
module.exports = require("b71655346619f3bb").getBundleURL("hWUTQ") + "harresh.d4d68a70.jpg" + "?" + Date.now();

},{"b71655346619f3bb":"lgJ39"}],"eIptc":[function(require,module,exports) {
module.exports = require("b5eb6836064f9d9d").getBundleURL("hWUTQ") + "izmer.8b531895.jpg" + "?" + Date.now();

},{"b5eb6836064f9d9d":"lgJ39"}],"aRgeV":[function(require,module,exports) {
module.exports = require("e2a0e81901588716").getBundleURL("hWUTQ") + "korremar.c93a4d09.jpg" + "?" + Date.now();

},{"e2a0e81901588716":"lgJ39"}],"bYaMo":[function(require,module,exports) {
module.exports = require("92fff6a98ebe2423").getBundleURL("hWUTQ") + "lightning_hyren.6de3c2a6.jpg" + "?" + Date.now();

},{"92fff6a98ebe2423":"lgJ39"}],"gxtEa":[function(require,module,exports) {
module.exports = require("bef78cd5624678cb").getBundleURL("hWUTQ") + "ninibom.375c9a88.jpg" + "?" + Date.now();

},{"bef78cd5624678cb":"lgJ39"}],"kOY6C":[function(require,module,exports) {
module.exports = require("d43784c65ab03d5e").getBundleURL("hWUTQ") + "ninx.11eebe85.jpg" + "?" + Date.now();

},{"d43784c65ab03d5e":"lgJ39"}],"9To9y":[function(require,module,exports) {
module.exports = require("64cebc038374a832").getBundleURL("hWUTQ") + "nkala.f50d57d2.jpg" + "?" + Date.now();

},{"64cebc038374a832":"lgJ39"}],"ezoMt":[function(require,module,exports) {
module.exports = require("db9c37df0b278584").getBundleURL("hWUTQ") + "pack_korrit.c884ed92.jpg" + "?" + Date.now();

},{"db9c37df0b278584":"lgJ39"}],"cXf1U":[function(require,module,exports) {
module.exports = require("2a3abfc5b8bea3df").getBundleURL("hWUTQ") + "sorreah.93266608.jpg" + "?" + Date.now();

},{"2a3abfc5b8bea3df":"lgJ39"}],"jF8u0":[function(require,module,exports) {
module.exports = require("5c91faa48f749c49").getBundleURL("hWUTQ") + "velouria.ab0dc5a0.jpg" + "?" + Date.now();

},{"5c91faa48f749c49":"lgJ39"}],"dzo96":[function(require,module,exports) {
module.exports = require("477257ba84ccb2a7").getBundleURL("hWUTQ") + "weebo.5c286bb9.jpg" + "?" + Date.now();

},{"477257ba84ccb2a7":"lgJ39"}],"9c7ER":[function(require,module,exports) {
module.exports = require("6a93be57489f4d27").getBundleURL("hWUTQ") + "wellisk.e4824d53.jpg" + "?" + Date.now();

},{"6a93be57489f4d27":"lgJ39"}],"4mik1":[function(require,module,exports) {
/**!
 * Sortable 1.15.0
...
const state = {
    ...
    player1Board: [],
    activeDeck: [
        (0, _cardsJs.creatures)[0]
    ],
    deck1: [],
    deck2: []
};

},{"./cards.js":"8nBRx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d8XZh","aenu9"], "aenu9", "parcelRequireff5e")
